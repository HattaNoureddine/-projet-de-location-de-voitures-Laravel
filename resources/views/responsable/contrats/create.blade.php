      ...
      <div class="row">
        <div class="col-xl">
          <div class="card mb-4">
            ...
            <div class="card-body">
              <form action="/contrat/store" method="POST">
                @csrf
                <div class="mb-3">
                  <label class="form-label" for="basic-default-fullname">date_debut</label>
                  <input type="date" name="date_debut" class="form-control" id="basic-default-fullname" placeholder="date reservation" />
                </div>
                <div class="mb-3">
                  <label class="form-label" for="basic-default-company">date_fin</label>
                  <input type="date" name="date_fin" class="form-control" id="basic-default-company" placeholder="date debut" />
                </div>
